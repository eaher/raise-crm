...
function calcularRaiseAds() {
    ...
    //const saldoPublicitario = (paqueteContratado / 2) - ((paqueteContratado / 2) * 0.2925863045);  avalon
    const saldoPublicitario = (paqueteContratado / 2) - ((paqueteContratado / 2) * 0.316986544634929); //FG
